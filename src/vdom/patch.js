...
/**
 * 
 * @param {dom} parentDomElement 父元素节点
 * @param {Array} oldChildren 老的孩子节点
 * @param {Array} newChildren 新的孩子节点
 */
function updateChildren(parentDomElement, oldChildren, newChildren) {
    ...
    while (oldStartIndex <= oldEndIndex && newStartIndex <= newEndIndex) {
        ...
        if (!oldStartVnode) {
            ...
            parentDomElement.insertBefore(oldStartVnode.domElement, oldEndVnode.domElement
            );
            oldStartVnode = oldChildren[++oldStartIndex];
            newEndVnode = newChildren[--newEndIndex];
